...
void 
MtBase<TypeMtHash, TypeData, TypeKey, TypeHasher, TypeKeyExt>::AddWithKnownHash(const Iterator& a_iter, const TypeKey& a_key, size_t a_hash)
{
...
template <typename TypeMtHash, typename TypeData, typename TypeKey, typename TypeHasher, typename TypeKeyExt >
void
MtBase<TypeMtHash, TypeData, TypeKey, TypeHasher, TypeKeyExt>::AddEvenIfExist(const Iterator& a_iter, const TypeKey& a_key)
{
...
MtBase<TypeMtHash, TypeData, TypeKey, TypeHasher, TypeKeyExt>::AddIfNotExist(const Iterator& a_iter, const TypeKey& a_key)
{
