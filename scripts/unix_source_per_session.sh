...
makeMainJob (){
	...
	export cpputilsRepoRoot
	echo cpputilsRepoRoot=$cpputilsRepoRoot

        source ${cpputilsRepoRoot}/contrib/cinternal/scripts/unix_source_per_session.sh ${cpputilsRepoRoot}/contrib/cinternal/scripts/unix_source_per_session.sh ${cpputilsRepoRoot}/contrib/cinternal/scripts/unix_source_per_session.sh
